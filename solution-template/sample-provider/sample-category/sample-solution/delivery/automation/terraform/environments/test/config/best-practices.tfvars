#------------------------------------------------------------------------------
# AWS Well-Architected Best Practices - Backup, Budgets, Config Rules, GuardDuty - TEST Environment
#------------------------------------------------------------------------------
...
backup = {
  ...
  monthly_retention = 30  # Monthly backup retention (days)
  ...
  weekly_retention = 14  # Weekly backup retention (days)
...
budget = {
  ...
  alert_thresholds = [50, 80, 100]  # Budget alert threshold percentages
